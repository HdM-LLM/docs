...
- **Screenshot**: Insert a screenshot here showing the CV upload interface.
...
- **Screenshot**: Insert a screenshot here showing the list of applicants and the details button.
...
- **Screenshot**: Insert a screenshot here showing the detailed overview of an applicant's scores.

These instructions provide a comprehensive guide for users to efficiently generate vacancies and upload new applicants, with visual aids at key steps to ensure clarity and ease of use.
